...
class Simulator:
    ...
    def run_simulation(self, start_location, time_frame, store_results_as=None, **kwargs):
        ...
        kwargs['atmospheric_model'] = self.atmospheric_model
...
def run_simulation(start_location, time_frame, **kwargs):
    ...
    ocean_model = kwargs.pop('ocean_model', metocean.ECMWFOcean)
    atmospheric_model = kwargs.pop('atmospheric_model', metocean.NARRAtmosphere)
    ...
    ocean = ocean_model(time_frame)
    atmosphere = atmospheric_model(time_frame)
    ...
    current_data = ocean.eastward_current_velocities.values, ocean.northward_current_velocities.values
